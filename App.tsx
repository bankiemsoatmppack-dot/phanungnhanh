...
const App: React.FC = () => {
  ...
  // 2. If User Role is USER, show Mobile First View (Images 2, 3, 4)
  if (user.role === 'USER') {
    return <MobileUserView user={user} onLogout={() => setUser(null)} />;
  }

  // 3. If User Role is ADMIN, show Dashboard/Desktop View with Sidebar
  return (
    <div className="flex h-screen w-full bg-soft-bg font-sans">
      {/* Sidebar Navigation */}
      <Sidebar 
